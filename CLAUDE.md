# CLAUDE.md — qsl-attachments (thin pointer; governance is authoritative)
...
- qsl-attachments is opaque ciphertext-only object storage. Plaintext/key exposure class must remain no. Never add content awareness, decryption, or key material handling.
